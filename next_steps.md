...
git branch -M main
git remote add origin git@github.com:QuantumApplicationLab/quantumnewtonraphson
```
...
and create a new repository named `quantumnewtonraphson` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/QuantumApplicationLab/quantumnewtonraphson/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
